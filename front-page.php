	...
	<div class="home-hero-section">
		<div class="hero-content">
			...
			<div class="call-to-action">
				<a class="button" href="/algemene-informatie/openingstijden/"
					aria-label="Lees meer over openingstijden">Openingstijden</a>
			...
			<div class="featured-instructor featured-instructor-yellow">
				...
				<div class="post-content">
					<h3><a href="<?php the_permalink(); ?>" rel="bookmark"
							...
							aria-label="Lees meer over <?php the_title(); ?>"><?php the_title(); ?></a></h3>
